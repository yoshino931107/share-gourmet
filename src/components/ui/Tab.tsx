    ...
    <>
      <footer className="fixed bottom-0 left-1/2 z-30 grid w-full max-w-[420px] -translate-x-1/2 grid-cols-4 bg-transparent text-center text-orange-950">
        <div className="relative flex h-20 items-end transition-transform duration-200">
          <Link
            href="/share"
            className={`flex h-15 w-full flex-col items-center rounded-t-xl border border-yellow-800 p-2 shadow-[0_-4px_6px_rgba(145,145,145,0.2)] transition-all duration-200 ${
              pathname === "/share"
        ...
        <div className="relative flex h-20 items-end transition-transform duration-200">
          ...
          >
            <Image src="/map-icon.svg" alt="map SVG" width={32} height={32} />
